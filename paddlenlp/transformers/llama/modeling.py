...
from paddle_xpu_nn import xpu_fusion_rotary_call
...
class LlamaRMSNorm(nn.Layer):
    ...
    def forward(self, hidden_states):
        ...
        with paddle.amp.auto_cast(False):
            ...
            p = 1/paddle.sqrt(variance + self.variance_epsilon)
    ...
    def forward(
        ...
        if self.config.rope:
            ...
            if self.rope_fusion_level == "full":
                ...
                query_states, key_states = xpu_fusion_rotary_call(cos, sin, query_states, key_states,
                                                                  query_states.shape[0], self.seq_length,
